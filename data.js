...
const RESERVAS_BASE = [
  ...
  {id:'b-hb2-01',room:'HB 2',guest:'Huésped 01',    ci:'2026-01-30',co:'2026-02-01',canal:'booking',bruto:99,    com:-14.85,neto:79.47},
  {id:'b-hb2-02',room:'HB 2',guest:'Huésped 02',        ci:'2026-02-06',co:'2026-02-08',canal:'booking',bruto:108,   com:-16.20,neto:86.70},
  {id:'b-hb2-03',room:'HB 2',guest:'Huésped 03',     ci:'2026-02-13',co:'2026-02-15',canal:'booking',bruto:108,   com:-16.20,neto:86.70},
  {id:'b-hb2-04',room:'HB 2',guest:'Huésped 04',         ci:'2026-02-27',co:'2026-03-02',canal:'booking',bruto:165,   com:-24.75,neto:132.45},
  {id:'b-hb2-05',room:'HB 2',guest:'Huésped 05',       ci:'2026-02-27',co:'2026-03-01',canal:'booking',bruto:99,    com:-14.85,neto:79.47},
  {id:'b-hb2-06',room:'HB 2',guest:'Huésped 06',    ci:'2026-03-18',co:'2026-03-21',canal:'booking',bruto:150,   com:-22.50,neto:120.42},
  ...
  // HB6 (Roma) — Airbnb
  {id:'a-hb6-01',room:'HB 6',guest:'Huésped 07', ci:'2026-01-23',co:'2026-01-25',canal:'airbnb',  bruto:108,  com:-3.92,neto:104.08},
  {id:'a-hb6-02',room:'HB 6',guest:'Huésped 08',       ci:'2026-02-13',co:'2026-02-15',canal:'airbnb',  bruto:108,  com:-3.92,neto:104.08},
  // HB6 (Roma) — Booking
  {id:'b-hb6-01',room:'HB 6',guest:'Huésped 09',         ci:'2026-01-02',co:'2026-01-04',canal:'booking', bruto:120,  com:-18.00,neto:96.33},
  {id:'b-hb6-02',room:'HB 6',guest:'Huésped 10',        ci:'2026-02-06',co:'2026-02-08',canal:'booking', bruto:220,  com:-33.00,neto:176.60},
  {id:'b-hb6-03',room:'HB 6',guest:'Huésped 11',       ci:'2026-02-06',co:'2026-02-08',canal:'booking', bruto:110,  com:-16.50,neto:88.30},
  {id:'b-hb6-04',room:'HB 6',guest:'Huésped 12',       ci:'2026-02-13',co:'2026-02-15',canal:'booking', bruto:110,  com:-16.50,neto:88.30},
  {id:'b-hb6-05',room:'HB 6',guest:'Huésped 13',      ci:'2026-02-20',co:'2026-02-23',canal:'booking', bruto:165,  com:-24.75,neto:132.45},
  {id:'b-hb6-06',room:'HB 6',guest:'Huésped 14',    ci:'2026-03-06',co:'2026-03-09',canal:'booking', bruto:150,  com:-22.50,neto:120.42},
  {id:'b-hb6-07',room:'HB 6',guest:'Huésped 15',        ci:'2026-03-13',co:'2026-03-15',canal:'booking', bruto:100,  com:-15.00,neto:80.28},
  // HB8 (Venecia) — Booking
  {id:'b-hb8-01',room:'HB 8',guest:'Huésped 16',      ci:'2026-01-02',co:'2026-01-04',canal:'booking', bruto:110,  com:-16.50,neto:88.30},
  {id:'b-hb8-02',room:'HB 8',guest:'Huésped 17',        ci:'2026-01-16',co:'2026-01-18',canal:'booking', bruto:96,   com:-14.40,neto:77.06},
  {id:'b-hb8-03',room:'HB 8',guest:'Huésped 18',        ci:'2026-02-13',co:'2026-02-15',canal:'booking', bruto:110,  com:-16.50,neto:88.30},
  {id:'b-hb8-04',room:'HB 8',guest:'Huésped 19',      ci:'2026-02-21',co:'2026-02-22',canal:'booking', bruto:32.73,com:-4.91, neto:26.27},
  {id:'b-hb8-05',room:'HB 8',guest:'Huésped 20',     ci:'2026-02-18',co:'2026-02-22',canal:'booking', bruto:220,  com:-33.00,neto:176.61},
  {id:'b-hb8-06',room:'HB 8',guest:'Huésped 21',          ci:'2026-03-13',co:'2026-03-15',canal:'booking', bruto:90,   com:-13.50,neto:72.25},
  {id:'b-hb8-07',room:'HB 8',guest:'Huésped 22',        ci:'2026-03-21',co:'2026-03-23',canal:'booking', bruto:100,  com:-15.00,neto:80.28},
  // HB9 (Murano) — Airbnb
  {id:'a-hb9-01',room:'HB 9',guest:'Huésped 23',ci:'2026-02-08',co:'2026-02-28',canal:'airbnb',  bruto:416.25,com:-15.11,neto:401.14},
  {id:'a-hb9-02',room:'HB 9',guest:'Huésped 24',            ci:'2026-02-28',co:'2026-04-01',canal:'airbnb',  bruto:162,  com:-5.44, neto:156.56},
  // HB9 (Murano) — Booking
  {id:'b-hb9-01',room:'HB 9',guest:'(sin nombre)',        ci:'2026-01-02',co:'2026-01-05',canal:'booking', bruto:147,  com:-22.05,neto:118.01},
  {id:'b-hb9-02',room:'HB 9',guest:'Huésped 25',       ci:'2026-01-16',co:'2026-01-18',canal:'booking', bruto:96,   com:-14.40,neto:77.06},
  {id:'b-hb9-03',room:'HB 9',guest:'Huésped 26',       ci:'2026-02-27',co:'2026-03-01',canal:'booking', bruto:110,  com:-16.50,neto:88.30},
  {id:'b-hb9-04',room:'HB 9',guest:'Huésped 27',    ci:'2026-03-06',co:'2026-03-08',canal:'booking', bruto:99,   com:-14.85,neto:79.47},
  {id:'b-hb9-05',room:'HB 9',guest:'Huésped 28',    ci:'2026-03-19',co:'2026-03-21',canal:'booking', bruto:90,   com:-13.50,neto:72.25},
