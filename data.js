...
const GASTOS_FIJOS_DEFAULT=[
  ...
  // Luz: ene–mar de facturas reales (gastos_1t.xlsx). Abr en adelante SIN valor: cada mes se
  // carga con su factura real (foto del ticket + pill "Fijo recurrente"). NUNCA estimar.
  {id:'gf06',n:'Luz (Octopus/Reazziona)',cat:'suministros', sys:true, m:{1:553.82,2:483.88,3:348,4:0,5:0,6:0,7:0,8:0,9:0,10:0,11:0,12:0}},
